...
const cardImages = [
    'images/card1.png', 'images/card2.png', 'images/card3.jpg', 'images/card4.jpg',
    ...
    'images/card29.png', 'images/card30.webp', 'images/card31.png', 'images/card32.jpg',
];
            ...
            currentCard.addEventListener("click", () => {
                ...
                if (nbrflipped == totalCards) {
                    ...
                    playagainbtn.addEventListener("click", () => {
                        ...
                        count = 0;
                        mycards.style.display = "grid";
                        document.querySelectorAll(".card").forEach(current => {
                            current.classList.remove("flip", "decorate");
                        });
                    });
                    finalMsg.append(playagainbtn);
                    playagainbtn.classList.add("button-decoraation");
                    startoverbtn.classList.add("button-decoraation");
                }
            });
        });
    }
